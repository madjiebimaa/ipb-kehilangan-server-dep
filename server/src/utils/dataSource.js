...
var item_entity_2 = require("../entities/item.entity");
...
(0, dotenv_1.config)();
var _a = process.env, DB_TYPE = _a.DB_TYPE, DB_HOST = _a.DB_HOST, DB_PORT = _a.DB_PORT, DB_USERNAME = _a.DB_USERNAME, DB_PASSWORD = _a.DB_PASSWORD, DB_NAME = _a.DB_NAME;
exports.AppDataSource = new typeorm_1.DataSource({
    ...
    database: DB_NAME,
    entities: [user_entity_1.User, post_entity_1.Post, item_entity_2.Item, item_entity_1.ItemImage, item_entity_1.ItemCharacteristic, session_entity_1.Session],
    synchronize: true,
    logging: true
});
var initializeDataSource = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                err_1 = _a.sent();
                logger_1.logger.error("Error during Data Source initialization:", err_1);
                process.exit(1);
                return [3 /*break*/, 3];
